...
function [termflag] = m3d_inputgen(P_mat_ind, R_vec_ind, box_length, result_dir)

  %# Generate input script:
  fi2 = fopen([result_dir, 'Abq_input_script.py'], 'wt');
  fprintf(fi2,'##\n');
  fprintf(fi2,'## Header:\n');
  ...
  fprintf(fi2,'    \n');
  fprintf(fi2,'    s = mdb.models[''Model-1''].ConstrainedSketch(name=''profile__'',\n'); ...
  ...
  fprintf(fi2,'del mdb.models[''Model-1''].sketches[''profile__'']\n');
  fprintf(fi2,'\n');
  fprintf(fi2,'p = mdb.models[''Model-1''].parts[''Mote3D'']\n');
