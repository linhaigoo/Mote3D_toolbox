...
function [termflag] = m3d_vxmesh(P_mat_ind, R_vec_ind, box_length, el_number, el_type, result_dir)
  ...
  Nmesh = zeros([el_number, el_number, el_number]);
  ntemp = zeros([el_number, el_number]);
  ...
  fi3 = fopen([result_dir, 'Abq_voxel_mesh.py'], 'wt');
  fprintf(fi3,'##\n');
  fprintf(fi3,'## Header:\n');
  ...
  fprintf(fi3,'##\n');
  fprintf(fi3,'s = mdb.models[''Model-1''].ConstrainedSketch(name=''profile__'',\n'); ...
